...
local color3 = Color3.fromRGB(0, 149, 255)
local color3_2 = Color3.fromRGB(59, 186, 255)
...
function t1.value11(p2, p3, p4)
    ...
    Frame.Parent = p2
    Frame.BackgroundColor3 = Color3.fromRGB(100, 200, 255)
    ...
    UIGradient.Color = ColorSequence.new({
		...
		ColorSequenceKeypoint.new(0.5, Color3.fromRGB(0, 149, 255)),
...
function t1.value15(p8)
    for i = 1, 5 do
        ...
        Frame.Parent = p8
        Frame.BackgroundColor3 = Color3.fromRGB(0, 149, 255)
        Frame.BorderSizePixel = 0
...
function t1.value16()
    ...
    UIStroke.Color = Color3.fromRGB(0, 149, 255)
    ...
    UIGradient.Color = ColorSequence.new({
		ColorSequenceKeypoint.new(0, Color3.fromRGB(0, 149, 255)),
		ColorSequenceKeypoint.new(0.5, Color3.fromRGB(255, 255, 255)),
		ColorSequenceKeypoint.new(1, Color3.fromRGB(0, 149, 255))
	})
...
(function()
    ...
    local function u258()
        ...
        t1.value1:Create(v252, TweenInfo.new(0.1, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {
			TextColor3 = Color3.fromRGB(v985 * 0.5 + 0, v985 * 0.4 + 149, 255)
		}):Play()
        v252.Text = v985 .. "%"
...
t1.value19 = t1.value18:MakeWindow({
	Title = "Pulsar Hub | Tecnoblade never dies",
	SubTitle = "Updated - by Dazzy and Sonolento",
	LoadText = "PulsarHub",
	Flags = "PulsarAsWere"
})
...
local t2 = {
	Image = "rbxassetid://72952502928020",
...
v133:AddSection({ "Pulsar Emotes By Dazzy" })
v133:AddButton({
	Name = "Pulsar Emotes",
	Callback = function()
...
v133:AddSection({ "Pulsar Fly By Dazzy" })
v133:AddButton({
	Name = "Pulsar Fly",
	Callback = function()
